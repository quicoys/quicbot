...
----------------------------------------------------------------------------
    ...
    { command: "pos" || "coords", description: "[coord/cord/pos]generates random, FAKE co-ordinates for the specifed user, basically a false position (optional input)" },
    ...
    { command: "ask" || "askgod" || "ask" || "8ball" || "eightball", description: "ask the gods of Gaggoys a question." },
    ...
    { command: "tps", description: "retrives ticks per second via TPS plugin" },
    ...
    { command: "pingquicoys", description: "[disturbqu/pingqui] ping quicoys (owner) in the quicbot discord via minecraft!" },
    ...
    { command: "top"|| "leader", description: "[leader] guessnumber[g]/playtime[p]/joins[j]/leaves[l]/dabup[d]/quiccoins[b]/command[c]" },
    { command: "chatgpt" || "ai", description: "[chatg/ai/gpt] ask the ai something! (optional input)" },
    { command: "version", description: "[ve/v./dev]replies with current quicbot version" },
    ...
    { command: "reddit", description: "[redd] get the latest post from a provided subreddit! (input)" },
    { command: "fact", description: "[fact/randomf/uselessf] get a random (useless?) fact provided by an API." },
    { command: "bible", description: "[bib] get a random verse from the bible." },
    { command: "weather", description: "get the weather information from inputted city! (optional input, optional \"advanced\" for the first argument after command)" },
    { command: "pollution", description: "[pollution/airp] get the air pollution information from inputted city! (input)" },
    { command: "crypto", description: "[crypto] check how much a cryptocoin is worth. (optional input, default is bitcoin)" }, 
    { command: "definition", description: "[defin] get an explanation from inputted word args 1 can be example to retrieve example of word usage (input (optional input))" },
    { command: "translate", description: "[transl] translate text by inputting <langauge> <the text you want to translate!>" },  
    { command: "timezone", description: "[timez] check the current time in different timezones! (optional input)" }, 
    { command: "population", description: "[worldpop/pop] check the current population on earth! Have you heard about the earth? (optional input)" }, 
    { command: "news", description: "view the latest headlines!" },  
    { command: "2b2t", description: "view the wait time of 2b2t's queue!" },  
    { command: "exophs" || "exophorism", description: "i think he's awesome!" },
    { command: "compjd", description: "compares two different players joindate" },
